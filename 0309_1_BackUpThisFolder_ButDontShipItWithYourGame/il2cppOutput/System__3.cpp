...
IL_00de:
		...
		try
		{
			...
			}
			{
				...
				L_11 = VirtualFuncInvoker0< SafeFileHandle_t033FA6AAAC65F4BB25F4CBA9A242A58C95CD406E* >::Invoke(31, ((FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8*)CastclassClass((RuntimeObject*)L_10, FileStream_t07C7222EE10B75F352B89B76E60820160FF10AD8_il2cpp_TypeInfo_var)));
				V_2 = L_11;
				goto IL_0076_1;
			}
...
{
	{
		Process_EnsureState_mAF2E5BE1A4336E9710E74508D3A9B16C7049B8F1(__this, 1, NULL);
		int32_t L_0 = __this->___processId;
		return L_0;
	}
}
...
IL_0363:
	{
		...
		NullCheck(L_144);
		VirtualActionInvoker1< bool >::Invoke(25, L_144, (bool)1);
